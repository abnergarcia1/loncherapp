...
import (
	...
	handlers "bitbucket.org/edgelabsolutions/loncherapp-routes-service/app/handlers"
...
func StartAPI() (close func(), err error) {
	...
	server := handlers.NewRoutesAPIServer(ctx)

	grpcServer := grpc.NewServer()

	pb.RegisterRoutesServiceServer(grpcServer, server)

	reflection.Register(grpcServer)

	log.Info("GRPC Routes started and serving")
